...
namespace Infra
{
    ...
    public class CP : GameParameters.CustomParameterNode
    {
        ...
        [GameParameters.CustomParameterUI("Use simple population growth",
            toolTip = "If false, then the enhanced population growth model will be used")]
        public bool useSimplePop = false;
