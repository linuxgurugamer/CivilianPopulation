...
namespace CivilianPopulation
{
	...
	public class CivilianPopulationGUI : MonoBehaviour
	{
		private Rect _windowPosition = new Rect(Screen.width / 2 - 250, Screen.height / 2 - 250, 500, 300);
		private bool showPopInfo = false;
		private string assetFolder = "CivilianPopulation/GUI/";
		private bool CivPopGUIOn = false;
